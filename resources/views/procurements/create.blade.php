        ...
        <div class="col-12 col-lg-9">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-header bg-white d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <div>
                        <h5 class="mb-0">Add Procurement</h5>
                        <small class="text-muted">New procurement entry based on Work and Financial Plan</small>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('procurements.store') }}">
                        @php($procurement = new \App\Models\Procurement())
