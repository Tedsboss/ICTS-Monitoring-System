...
@section('content')
  <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur" data-scroll="false">
    <div class="container-fluid py-1 px-3">
      @include('layouts.navbars.auth.topnav', ['title' => 'New Submission'])
      ...
      <div class="col-12">
        <div class="card submission-page-card">
          <div class="card-header">
            <p class="submission-eyebrow mb-1">New Indicator Submission</p>
          ...
          <div class="card-body p-3">
            <form method="post" action="{{ route('submissions.store') }}" autocomplete="off">
