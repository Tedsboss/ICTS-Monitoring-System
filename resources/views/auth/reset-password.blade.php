                ...
                <div class="card fadeIn1 fadeInLeft">
                  <div class="card-body">
                    <div class="py-3">
                      ...
                      <p class="mb-0">Enter your email to receive recovery link</p>
                    </div>
                    <form role="form" method="POST" action="{{ route('reset.perform') }}" id="frmReset">
                      @csrf
                      <div class="mb-3">
                      ...
                      <div class="text-center">
                        <button type="button" onclick="submitReset()" class="btn btn-md btn-info w-100 mt-4 mb-0">Reset</button>
                      </div>
                    </form>
                  </div>
...
@push('js')
  @include('recaptchas.script', ['form_name' => 'frmReset', 'form_action' => 'reset'])
@endpush