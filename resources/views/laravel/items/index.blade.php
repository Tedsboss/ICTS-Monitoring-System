...
@section('content')
    <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            @include('layouts.navbars.auth.topnav', ['title' => 'Items Management'])
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        @can('manage-items')
                            <a href="{{ route('item-new') }}" class="btn bg-gradient-dark btn-sm float-end mb-0">Add Item</a>
                        @endcan
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <span class="my-2 text-xs">
                                                <img src="{{ $item->pictureUrl() }}" alt="item" class="border-radius-lg shadow-sm height-100 w-auto">
                                            </span>
                                        </td>
                                        ...
                                        <td class="text-sm">
                                            <span class="d-flex">
                                                @can('manage-items', auth()->user())
                                                    <a href="{{ route('item-edit', $item->id) }}" class="me-3" data-bs-toggle="tooltip"
                                                        data-bs-original-title="Edit item">
                                                        <i class="fas fa-user-edit text-secondary"></i>
                                                    </a>
                                                    <form action="{{ route('item-destroy', $item->id) }}" method="post">
                                                        @csrf
                                                        <button onclick="return confirm('Are you sure you want to remove the item?')"
