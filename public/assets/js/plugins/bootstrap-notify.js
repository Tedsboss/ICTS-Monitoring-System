...
(function (factory) {
	...
	var defaults = {
      ...
      <div data-notify="container" class="col-xs-11 col-sm-4 alert alert-{0}" role="alert">
        ...
        <span data-notify="icon"><i class="fa fa-pencil text-white"></i></span> 
        <span data-notify="title">{1}</span> 
        <span class="text-white" data-notify="message">{2}</span>
      ...
      //   <button type="button" aria-hidden="true" class="btn-close text-end" data-notify="dismiss"></button>
